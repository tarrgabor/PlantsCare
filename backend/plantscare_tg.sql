...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Jún 05. 11:16
...
ALTER TABLE `watering_logs`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `plant_id_2` (`plant_id`),
...
--
ALTER TABLE `watering_logs`
  ADD CONSTRAINT `watering_logs_ibfk_1` FOREIGN KEY (`plant_id`) REFERENCES `plants` (`id`);
COMMIT;
